...
def analyze_mle_with_aperture_dual(measurements_data, freq_hz):
    """
    ...
    try:
        ...
        # Estymacja kąta
        estimated_angle = MLE_sar_full_aperture_dual(Y, element_positions_mm, freq_hz)
...
if __name__ == "__main__":
    ...
    angle_sar_aperture_dual = analyze_mle_with_aperture_dual(measurements_data, SignalFreq)
